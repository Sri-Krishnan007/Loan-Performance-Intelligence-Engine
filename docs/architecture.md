...
* **Responsibilities**:
  ...
  * **Custom/Local Model**: Handles low-latency tasks such as exception classification, rule mapping, and metadata severity checks.
  * **External LLM (Gemini / OpenAI)**: Generates high-context reviewer summaries, record correction recommendations, and human-friendly exception explanations.
