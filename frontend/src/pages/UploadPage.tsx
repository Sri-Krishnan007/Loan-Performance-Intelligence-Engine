        ...
        {isFinished && results && (
          <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-3 border-t border-slate-700">
              ...
              <button
                onClick={() => {
                  // Swapping role helper triggers Lead Reviewer redirection
                  localStorage.setItem('user_role', 'reviewer');
                  localStorage.setItem('user_name', 'Lead Reviewer');
                  localStorage.setItem('user_email', 'reviewer@demo.local');
                  showToast('Demo helper: Simulating reviewer transition', 'info');
                  navigate('/reviewer/exceptions');
                }}
              ...
              >
                <span>Go to Exception Queue</span>
